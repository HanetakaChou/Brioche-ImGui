...
#include "imgui_pipeline_resource_binding.bsli"
...
brx_vertex_shader_parameter_end(main)
{
    brx_uint vertex_index;
    {
        ...
        brx_uint2 unpacked_vector_index_binding = brx_R16G16_UINT_to_UINT2(packed_vector_index_binding[index_uniform_buffer_index_aligned_4]);
    ...
    brx_float2 vertex_position;
    {
        ...
        vertex_position = brx_R16G16_SNORM_to_FLOAT2(packed_vector_vertex_position_binding[vertex_position_uniform_buffer_index_aligned_4]);
    }
    ...
    brx_float2 vertex_texcoord;
    {
        ...
        vertex_texcoord = brx_R16G16_UNORM_to_FLOAT2(packed_vector_vertex_texcoord_binding[vertex_texcoord_uniform_buffer_index_aligned_4]);
    }
    ...
    brx_float4 vertex_color;
    {
        ...
        vertex_color = brx_R8G8B8A8_UNORM_to_FLOAT4(packed_vector_vertex_color_binding[vertex_color_uniform_buffer_index_aligned_4]);
    }
