...
LOCAL_MODULE := BRX-ImGui-Font-Asset

LOCAL_SRC_FILES := \
    $(LOCAL_PATH)/../misc/fonts/noto_sans_cjk_jp_ttf.cpp \
    $(LOCAL_PATH)/../misc/fonts/noto_sans_symbols_ttf.cpp \
    $(LOCAL_PATH)/../misc/fonts/noto_sans_symbols2_ttf.cpp \
    $(LOCAL_PATH)/../misc/fonts/noto_sans_ttf.cpp
...
LOCAL_LDFLAGS += -Wl,--version-script,$(LOCAL_PATH)/BRX-ImGui-Font-Asset.map
...
LOCAL_SRC_FILES := \
	...
	$(LOCAL_PATH)/../backends/imgui_impl_glut.cpp \
...
LOCAL_STATIC_LIBRARIES :=
LOCAL_STATIC_LIBRARIES += BRX-ImGui-Font-Asset
