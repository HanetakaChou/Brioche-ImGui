...
extern "C" JNIEXPORT void ANativeActivity_onCreate(ANativeActivity *native_activity, void *saved_state, size_t saved_state_size)
{
    ...
    {
        g_wsi_state.m_ui_controller.m_show_demo_window = true;
        g_wsi_state.m_ui_controller.m_show_another_window = false;
        g_wsi_state.m_ui_model.m_clear_color[0] = 0.45f;
        g_wsi_state.m_ui_model.m_clear_color[1] = 0.55f;
        g_wsi_state.m_ui_model.m_clear_color[2] = 0.60f;
...

        {
            ...
            static std::string g_IniFilename = std::string(native_activity->internalDataPath) + "/imgui.ini";
...
int main(int argc, char *argv[])
{
    ...
    {
        xcb_void_cookie_t cookie_change_property_wm_name = xcb_change_property(connection, XCB_PROP_MODE_REPLACE, window, XCB_ATOM_WM_NAME, XCB_ATOM_STRING, 8 * sizeof(uint8_t), 28, "Brioche ImGui");
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    HWND window = NULL;
    {
        ...
        wsi_state.m_renderer = renderer_init(NULL);
