...
extern "C" IMGUI_IMPL_API void ImGui_ImplGLUT_MouseFunc(int button, bool down, int x, int y);                      // ~ MouseButtonFunc
extern "C" IMGUI_IMPL_API void ImGui_ImplGLUT_MouseWheelFunc(bool dir, int x, int y);                              // ~ MouseWheelFunc
extern "C" IMGUI_IMPL_API void ImGui_ImplGLUT_KeyboardFunc(int key, bool ctrl, bool shift, bool alt, bool caps);   // ~ CharPressedFunc
extern "C" IMGUI_IMPL_API void ImGui_ImplGLUT_KeyboardUpFunc(int key, bool ctrl, bool shift, bool alt, bool caps); // ~ CharReleasedFunc
